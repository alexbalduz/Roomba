...
def tiempoLimpiezaEnMinutos(superficieALimpiar,  
tiempoParaUnMetroCuadrado):  
...
#Llamada de la función que permite calcular la superficie 
#a limpiar  
...
#Llamada de la función que permite determinar el tiempo 
#de limpieza  
...
#Añade una condición que se activa en función del tiempo 
#de limpieza  
